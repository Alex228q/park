...
const LockBlock34 = () => {
  return (
    <div style={{ position: "absolute" }}>
      ...
      <Valve toUp top={774} left={2463} title={"48"} valveColor="red" />
      ...
      <Line isHorizontal length={15} top={876} left={2559} />
      <Valve toUp top={859} left={2574} title={"49"} valveColor="red" />
      <Line isHorizontal length={52} top={877} left={2604} />
    </div>
  );
};
