...
const TopTanks = () => {
  return (
    <>
      ...
      <Tank title="E-327" productType="ЗГПН" top={150} left={190 * 8} />
      <Tank title="E-329" productType="ЗГПН" top={150} left={190 * 10} />
      <Tank title="E-331" productType="ЗГПН" top={150} left={190 * 13} />
