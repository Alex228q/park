...
const T329to115P1 = () => {
  ...
  if (selectedTank === "E-329" && selectedPumps115.includes("H-1")) {
    color = "green";
    index = 20;
    valveColor = "green";
  }
  return (
    <div style={{ zIndex: index, position: "absolute" }}>
      ...
      <Line isHorizontal length={1238} top={1279} left={350} color={color} />
      <Line length={50} top={1279} left={350} color={color} />
      <Valve
        top={1329}
        left={344}
        title={"ЗМ-12"}
